		...
		<div class="row" style="margin-bottom:200px;">
			<div class="col-lg-12">
				<h1 class="page-header">
				   <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Daftar <small>Pegawai</small>
					...
					<div class="header-content">
						<div class="header-content-inner">
                            ...
                            <div class="col-md-2" style="padding:0 0 0 0; margin-bottom:1.5%;">
                                <h4 >
                                    <a href="<?php echo site_url ("c_user_pegawai/tambah");?>" class="btn btn1 red" style="text-decoration:none; color:#FFF; "><span class="glyphicon glyphicon-plus-sign"></span> Tambah Data</a>
                                </h4>
                            </div>
                            <div class="clear"></div>
							<div class="table-responsive body_table font_isi">  
                                ...
                                <thead class="#" >
                                    <tr>
                                        ...
                                        <td width="17%" align="center"><b>Kode Pegawai</b></td>
                                        <td width="28%" align="center"><b>Nama</b></td>
                                        <td width="20%" align="center"><b>Jenis Kelamin</b></td>
                                        <td width="16%" align="center"><b>Type</b></td>
                                        <td width="14%"></td>
                                    </tr>
                                </thead>
                                <tbody>
                                  ...
                                  ?>
                                    ...
                                    <tr>
                                        ...
                                        <td id="isi_tb"><?php echo $baris->kode_pegawai;?></td>
                                        <td id="isi_tb"><?php echo $baris->nama;?></td>
                                        <td id="isi_tb"><?php echo $baris->jenis_kelamin;?></td>
                                        <td id="isi_tb"><?php echo $baris->type;?></td>
                                        <td align="center"> <button type="button" name="btn_ubah" class="btn btn1 red" style="text-decoration: none;" onClick="location.href=('<?php echo  $baris->kode_pegawai ?>','<?php echo site_url("c_user_pegawai/ubah/".md5(sha1($baris->kode_pegawai)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-edit"></span></button>
                                        
                                        <button type="button" name="btn_hapus" class="btn btn1 red" style="text-decoration: none;" onclick="return hapus_data('<?php echo $baris->nama ?>','<?php echo site_url("c_user_pegawai/hapus/".$baris->kode_pegawai);?>');" data-toggle="tooltip" data-placement="top" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></button>
                                        </td>
                                    </tr>
