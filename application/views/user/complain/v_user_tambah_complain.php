		...
		<div class="row" style="margin-bottom:200px;">
			<div class="col-lg-12">
				<h1 class="page-header">
				   <span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Entry <small>Complain</small>
				...
				<div class="clear"></div>
                    <div class="col-md-6 col-md-offset-2 col">
                        <form action="<?php echo site_url("c_user_complain/tambah"); ?>" class="form-horizontal" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="tgl_complain" type="text" class="form-control"  id="tgl" value="<?php echo set_value("tgl_complain"); ?>" size="25" maxlength="11" placeholder="Isi Tanggal Complain" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="cbo_status" class="form-control" id="cbo_status">
                                        ...
                                        <option <?php if (!(strcmp(set_value("cbo_status"),"Sudah Diperbaiki"))) {echo "selected=\"selected\"";} ?> value="Sudah Diperbaiki"<?php echo set_value("cbo_status"); ?>>Sudah Diperbaiki</option>
                                        <option <?php if (!(strcmp(set_value("cbo_status"),"Belum Diperbaiki"))) {echo "selected=\"selected\"";} ?> value="Belum Diperbaiki"<?php echo set_value("cbo_status"); ?>>Belum Diperbaiki</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input name="tgl_perbaikan" type="text" class="form-control"  id="tgl2" value="<?php echo set_value("tgl_perbaikan"); ?>" size="25" maxlength="11" placeholder="Isi Tanggal Perbaikan">
                                </div>
                            </div>
