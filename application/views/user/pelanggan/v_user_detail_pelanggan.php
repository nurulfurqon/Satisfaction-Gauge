		...
		<div class="row" style="margin-bottom:200px;">
			<div class="col-lg-12">
				<h1 class="page-header">
				   <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Detail <small>Pelanggan</small>
				...
				<div class="clear"></div>
                    <div class="col-md-6 col-md-offset-2 col">
                        <form action="<?php echo site_url("c_user_pelanggan/ubah/". md5(sha1($pilih->id_pelanggan))); ?>" class="form-horizontal" method="post">
						<fieldset disabled>
