		...
		<div class="row" style="margin-bottom:200px;">
			<div class="col-lg-12">
				<h1 class="page-header">
				   <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Daftar <small>Data Kepuasan</small>
					...
					<div class="header-content">
						<div class="header-content-inner">
                            ...
                            <div class="col-md-2" style="padding:0 0 0 0; margin-bottom:1.5%;">
                                <h4 >
                                    <a href="<?php echo site_url ("c_user_data_kepuasan/tambah");?>" class="btn btn1 red" style="text-decoration:none; color:#FFF; "><span class="glyphicon glyphicon-plus-sign"></span> Tambah Data</a>
                                </h4>
                            </div>
                            <div class="clear"></div>
							<div class="table-responsive body_table font_isi">  
                                ...
                                <thead class="#" >
                                    	<tr>
                                            ...
                                            <td width="28%" align="center"><b>Jenis Complain</b></td>
                                            <td width="53%" align="center"><b>Pengukuran</b></td>
                                            <td width="14%"></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                      ...
                                      ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"> <button type="button" name="btn_ubah" class="btn btn1 red" style="text-decoration: none;" onClick="location.href=('<?php echo $baris->nama ?>','<?php echo site_url("c_user_data_kepuasan/detail/".md5(sha1($baris->id)));?>');" data-toggle="tooltip" data-placement="top" title="Detail Data"><span class="glyphicon glyphicon-edit"></span></button>
                                            
                                            <button type="button" name="btn_hapus" class="btn btn1 red" style="text-decoration: none;" onclick="return hapus_data('<?php echo $baris->nama ?>','<?php echo site_url("c_user_data_kepuasan/hapus/".$baris->id);?>');" data-toggle="tooltip" data-placement="top" title="Hapus Data"><span class="glyphicon glyphicon-trash"></span></button>
                                            </td>
                                        </tr>
