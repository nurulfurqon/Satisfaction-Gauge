		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Detail Jenis Complain
				</div>
				<br/>
				...
				<div class="col-md-6 col-md-offset-2 col">
					<form action="<?php echo site_url("c_adm_jenis_complain/detail/".md5(sha1($pilih->nama))); ?>" class="form-horizontal" method="post" name="frm">
