...
<title>Tambah Jenis Complain</title>
		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Entry Jenis Complain
				</div>
				<br/>
				<br/>
				...
				<div class="col-md-6 col-md-offset-2 col">
					<form action="<?php echo site_url("c_adm_jenis_complain/tambah"); ?>" class="form-horizontal" method="post">
						<div class="form-group">
							<label class="col-sm-4 control-label">Jenis Complain</label>
							<div class="col-sm-8">
								<input name="txt_jeniscomplain" type="text" class="form-control"  id="txt_jeniscomplain" value="<?php echo set_value("txt_jeniscomplain"); ?>" size="50" maxlength="25" placeholder="Isi Jenis Complain" autofocus>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="txt_point" type="text" class="form-control"  id="txt_point" value="<?php echo set_value("txt_point"); ?>" onKeyPress="return hanyaAngka(event, false)" size="15" maxlength="11" placeholder="Isi Point" autofocus> 
							</div>
						</div>
						<br/>
						<div class="col-sm-8 col-sm-offset-4">
								<input type="submit" name="btn_simpan" id="btn_simpan" class="btn btn-success" value="Simpan" />
								<input type="button" name="submit" id="submit" class="btn btn-default" value="Batal" onClick="location.href='<?php echo site_url("c_adm_jenis_complain");?>'" />
						</div>
					</form>
				</div>		
			</div>
