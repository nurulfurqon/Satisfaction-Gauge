		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Entry Complain
				</div>
				<br/>
				<br/>
				...
				<div class="col-md-7 col-md-offset-2 col">
					<form action="<?php echo site_url("c_adm_complain/tambah"); ?>" class="form-horizontal" method="post">
