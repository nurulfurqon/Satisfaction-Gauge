		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Entry Pelanggan
				</div>
				<br/>
				<br/>
				...
				<div class="col-md-6 col-md-offset-2 col">
					<form action="<?php echo site_url("c_adm_pelanggan/tambah"); ?>" class="form-horizontal" method="post">
