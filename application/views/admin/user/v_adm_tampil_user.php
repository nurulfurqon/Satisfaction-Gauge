					...
					<table class="table table-bordered table-hover" width="100%" >
						<thead class="navbar-default" >
							<tr>
                                ...
                                <td width="20%" align="center"><b>Nama Pegawai</b></td>
								<td width="24%" align="center"><b>Username</b></td>
								<td width="28%" align="center"><b>Password</b></td>
								<td width="23%"></td>
							</tr>
						</thead>
						<tbody>
						  ...
						  ?>
							...
							<tr>
								...
								<td align="center"> <button type="button" name="btn_ubah" class="-sm btn-link" style="text-decoration: none;" onClick="location.href=('<?php echo $baris->pegawai_id ?>','<?php echo site_url("c_adm_use/detail/".md5(sha1($baris->pegawai_id)));?>');"><span class="glyphicon glyphicon-eye-open"></span> Detail</button>
								
								<button type="button" name="btn_hapus" class="btn-sm btn-link" style="color:#ec4445; text-decoration: none;" onclick="return hapus_data('<?php echo $baris->username ?>','<?php echo site_url("c_adm_use/hapus/".$baris->id_user);?>');"><span class="glyphicon glyphicon-trash"></span> Hapus</button>
								</td>
							</tr>
