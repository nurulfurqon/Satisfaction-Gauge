		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Detail User
				</div>
				<br/>
				...
				<div class="col-md-6 col-md-offset-2 col">
					<form action="<?php echo site_url("c_adm_use/detail/".md5(sha1($pilih->pegawai_id))); ?>" class="form-horizontal" method="post" >
						<fieldset disabled>
						<div class="form-group">
							<label class="col-sm-4 control-label">Nama Pegawai</label>
							<div class="col-sm-8">
								<select name="txt_namapegawai" class="form-control">
									<option value="<?php echo $pilih->pegawai_id;  ?>" selected="selected"><?php echo $pilih->nama;  ?></option>
								</select>
							</div>
						</div>
						</fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="txt_username" type="text" class="form-control" id="txt_nama" value="<?php if($act == "0")  echo $pilih->username; if($act == "1") echo set_value('txt_username');?>" size="33" maxlength="30">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
							<input name="txt_password" type="text" class="form-control" id="txt_password" value="<?php if($act == "0") echo $pilih->password; if($act == "1") echo set_value('txt_password'); ?>" size="33" maxlength="30" >
							</div>
						</div>
						 ...
						 <div class="col-sm-8 col-sm-offset-4">
								...
								<input name="pegawai_id" type="hidden" id="id_pelanggan" value="<?php echo md5(sha1($pilih->pegawai_id)) ?>" />
