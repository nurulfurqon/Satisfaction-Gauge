		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Detail Pegawai
				</div>
				<br/>
				...
				<div class="col-md-6 col-md-offset-2 col">
					<form action="<?php echo site_url("c_adm_pegawai/ubah/".md5(sha1($pilih->kode_pegawai))); ?>" class="form-horizontal" method="post">
						<fieldset disabled>
