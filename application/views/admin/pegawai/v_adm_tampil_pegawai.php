		...
		<div class="row">
			...
			<div class="col-md-10">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Daftar Pegawai
				</div>
				<br/>
					...
					<table class="table table-bordered table-hover" width="100%" >
						<thead class="navbar-default" >
							<tr>
                                ...
                                <td width="12%" align="center"><b>Kode Pegawai</b></td>
								<td width="15%" align="center"><b>Nama</b></td>
								<td width="14%" align="center"><b>Jenis Kelamin</b></td>
								<td width="14%" align="center"><b>Type</b></td>
								<td width="19%"></td>
							</tr>
						</thead>
						<tbody>
						  ...
						  ?>
							...
							<tr>
								...
								<td align="center"> <button type="button" name="btn_ubah" class="btn-sm btn-link" style="text-decoration: none;" onClick="location.href=('<?php echo  $baris->kode_pegawai ?>','<?php echo site_url("c_adm_pegawai/ubah/".md5(sha1($baris->kode_pegawai)));?>');"><span class="glyphicon glyphicon-eye-open"></span> Detail</button>
								
								<button type="button" name="btn_hapus" class="btn-sm btn-link" style="color:#ec4445; text-decoration: none;" onclick="return hapus_data('<?php echo $baris->nama ?>','<?php echo site_url("c_adm_pegawai/hapus/".$baris->kode_pegawai);?>');"><span class="glyphicon glyphicon-trash"></span> Hapus</button>
								</td>
							</tr>
